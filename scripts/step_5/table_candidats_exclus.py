...
synth = prdmx.groupby(['Taxid', 'Species_name']).agg({
...
merge = merge[['Taxid', 'Accession', 'Species_name', 'Nb_SET', 'Complete_PRDMX nb', 'Complete_PRDMX', 'SET+KRAB+SSXRD nb', 'SET+KRAB+SSXRD', 'SET+KRAB+ZF nb', 'SET+KRAB+ZF', 'SET+KRAB nb', 'SET+KRAB']]
merge.to_csv('table_results/table_candidats_exclus.csv', sep = ';', index=False)
